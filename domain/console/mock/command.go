...
func (m *MockCommand) RunTask(taskfile string, fullName value.FullTaskName, args ...string) error {
	m.ctrl.T.Helper()
...
func (m *MockCommand) SelectTaskName(taskfile string) (value.FullTaskName, error) {
	m.ctrl.T.Helper()
